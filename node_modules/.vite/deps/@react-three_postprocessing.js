...
// node_modules/@react-three/postprocessing/dist/index.js
var G = (0, import_react.createContext)(null);
...
var Ne = (0, import_react.memo)(function({ children: e, camera: t, scene: n, resolutionScale: i, enabled: o = true, renderPriority: s = 1, autoClear: c2 = true, depthBuffer: l, enableNormalPass: u, stencilBuffer: d, multisampling: p = 8, frameBufferType: m2 = HalfFloatType, ref: h }) {
  let { gl: g, scene: y, camera: b, size: x } = useThree(), S = n || y, C2 = t || b, [w, T2] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
    ...
    e2.addPass(new RenderPass(S, C2));
    let t2 = null, n2 = null;
    return u && (t2 = new NormalPass(S, C2), t2.enabled = false, e2.addPass(t2), i !== void 0 && (n2 = new DepthDownsamplingPass({
      normalBuffer: t2.texture,
      resolutionScale: i
    }), n2.enabled = false, e2.addPass(n2))), e2.setSize(x.width, x.height), T2({
      composer: e2,
      normalPass: t2,
      downSamplingPass: n2
    }), () => {
    ...
    w == null ? void 0 : w.composer.setSize(x.width, x.height);
  }, [w, x]), useFrame((e2, t2) => {
    if (!o || !w) return;
    let { composer: n2 } = w, r = g.autoClear;
    g.autoClear = c2, d && !c2 && g.clearStencil(), n2.render(t2), g.autoClear = r;
  }, o ? s : 0);
  ...
  return (0, import_react.useImperativeHandle)(h, () => w == null ? void 0 : w.composer, [w]), D ? (0, import_jsx_runtime.jsx)(G.Provider, {
    value: D,
...
function Pe({ children: e, enabled: t = true }) {
  let [n, r] = (0, import_react.useState)([]), i = (0, import_react.useMemo)(() => ({
    selected: n,
    select: r,
    enabled: t
  }), [
  ...
  return (0, import_jsx_runtime.jsx)(K.Provider, {
    value: i,
    children: e
  });
}
...
function Ie({ enabled: e = false, children: t, ...n }) {
  var _a2;
  let r = (0, import_react.useRef)(null), i = (_a2 = (0, import_react.use)(K)) == null ? void 0 : _a2.select, a = (0, import_react.useRef)([]);
  return (0, import_react.useEffect)(() => {
    if (!i) return;
    let t2 = [];
    e && r.current.traverse((e2) => {
      Fe(e2) && t2.push(e2);
    });
    let n2 = a.current;
    a.current = t2, i((e2) => {
      let r2 = new Set(e2), i2 = new Set(t2), a2 = t2.filter((e3) => !r2.has(e3)), o = n2.filter((e3) => !i2.has(e3) && r2.has(e3));
      if (!a2.length && !o.length) return e2;
      let s = o.length ? new Set(o) : null, c2 = s ? e2.filter((e3) => !s.has(e3)) : e2;
      return a2.length ? [...c2, ...a2] : c2;
    });
  }, [
    e,
    t,
    ...
    let e2 = new Set(a.current);
    i((t2) => {
      let n2 = t2.filter((t3) => !e2.has(t3));
      return n2.length === t2.length ? t2 : n2;
    });
  }, [i]), (0, import_jsx_runtime.jsx)("group", {
    ref: r,
    ...n,
    children: t
  });
...
var q = [];
var J = (e) => typeof e == "object" && e && "current" in e ? e.current : e;
function Y(e, t, n) {
  let r = useThree((e2) => e2.invalidate), i = (0, import_react.use)(K);
  (0, import_react.useEffect)(() => {
    ...
    if (i) return;
    let n2 = (Array.isArray(t) ? t.map((e2) => J(e2)) : [J(t)]).filter((e2) => e2 != null);
    if (n2.length) return e.selection.set(n2), r(), () => {
      e.selection.clear(), r();
    };
  }, [
    e,
    ...
    var _a2;
    if (i && i.enabled && ((_a2 = i.selected) == null ? void 0 : _a2.length)) return e.selection.set(i.selected), r(), () => {
      e.selection.clear(), r();
    };
  }, [
    i,
...
var X = (e) => {
  let t = (0, import_react.useRef)(/* @__PURE__ */ new WeakSet());
  (0, import_react.useEffect)(() => {
    let n = t.current;
    return () => {
      var _a2;
      e && typeof e == "object" && !n.has(e) && (n.add(e), (_a2 = e.dispose) == null ? void 0 : _a2.call(e));
    };
  }, [e]);
};
var Z = (e, t) => {
  let n = e[t];
  return (0, import_react.useMemo)(() => typeof n == "number" ? new Vector2(n, n) : n ? new Vector2(...n) : new Vector2(), [n]);
};
var Le = 0;
...
function $(e, t) {
  return function({ ref: r, blendFunction: i = t == null ? void 0 : t.blendFunction, opacity: o = t == null ? void 0 : t.opacity, ...s }) {
    let c2 = Re.get(e);
    if (!c2) {
      let t2 = `@react-three/postprocessing/${e.name}-${Le++}`;
      extend({ [t2]: e }), Re.set(e, c2 = t2);
    }
    let l = useThree((e2) => e2.camera), u = (0, import_react.useMemo)(() => [...(t == null ? void 0 : t.args) ?? [], ...s.args ?? [{
      ...t,
      ...s
    }]], [He(s)]);
    return (0, import_jsx_runtime.jsx)(c2, {
      camera: l,
...
var We = class extends Effect {
  constructor({ font: e = "arial", characters: t = " .:,'-^=*+?!|0#X%WM@", fontSize: n = 54, cellSize: r = 16, color: i = "#ffffff", invert: a = false } = {}) {
    let o = /* @__PURE__ */ new Map([
      ["uCharacters", new Uniform(new Texture())],
      ["uCellSize", new Uniform(r)],
      ["uCharactersCount", new Uniform(t.length)],
      ["uColor", new Uniform(new Color(i))],
      ["uInvert", new Uniform(a)]
    ]);
  ...
  createCharactersTexture(e, t, n) {
    ...
    r.width = r.height = i;
    let a = new CanvasTexture(r, void 0, RepeatWrapping, RepeatWrapping, NearestFilter, NearestFilter), o = r.getContext("2d");
    ...
    for (let t2 = 0; t2 < e.length; t2++) {
      let n2 = e[t2], r2 = t2 % 16, i2 = Math.floor(t2 / 16);
      o.fillText(n2, r2 * 64 + 64 / 2, i2 * 64 + 64 / 2);
    }
    return a.needsUpdate = true, a;
  }
};
function Ge({ font: e = "arial", characters: t = " .:,'-^=*+?!|0#X%WM@", fontSize: n = 54, cellSize: r = 16, color: i = "#ffffff", invert: a = false, ref: o }) {
  let s = (0, import_react.useMemo)(() => new We({
    characters: t,
    font: e,
    fontSize: n,
    cellSize: r,
  ...
  return X(s), (0, import_jsx_runtime.jsx)("primitive", {
    ref: o,
    object: s
  });
}
function Ke({ ref: e, blendFunction: t, worldFocusDistance: n, worldFocusRange: r, focusDistance: i, focusRange: a, focalLength: o, bokehScale: s, resolutionScale: c2, resolutionX: l, resolutionY: u, width: d, height: f, target: p, depthTexture: h, ...g }) {
  let { camera: _ } = (0, import_react.use)(G), v4 = p != null, y = (0, import_react.useMemo)(() => {
    let e2 = new DepthOfFieldEffect(_, {
      blendFunction: t,
    ...
    v4 && (e2.target = new Vector3()), h && e2.setDepthTexture(h.texture, h.packing);
    let p2 = e2.maskPass;
    return p2.maskFunction = MaskFunction.MULTIPLY_RGB_SET_ALPHA, e2;
  }, [
    _,
    t,
    n,
  ...
  return X(y), (0, import_jsx_runtime.jsx)("primitive", {
    ...g,
    object: y,
    ref: e,
    target: p
...
function qe(e) {
  let t = false, n = e.dispose.bind(e);
  return e.dispose = () => {
    t || (t = true, n());
  }, e;
}
function Je({ target: e = void 0, mouse: n = false, debug: i = void 0, manual: o = false, smoothTime: s = 0.25, ref: c2, ...l }) {
  let u = (0, import_react.useRef)(null), f = (0, import_react.useRef)(null), p = (0, import_react.useRef)(null), m2 = useThree(({ scene: e2 }) => e2), g = useThree(({ pointer: e2 }) => e2), { composer: _, camera: v4 } = (0, import_react.useContext)(G), [y] = (0, import_react.useState)(() => qe(new DepthPickingPass())), [b] = (0, import_react.useState)(() => qe(new CopyPass()));
  (0, import_react.useEffect)(() => (_.addPass(y), _.addPass(b), () => {
  ...
  let [x] = (0, import_react.useState)(() => new Vector3(0, 0, 0)), [S] = (0, import_react.useState)(() => new Vector3(0, 0, 0)), C2 = (0, import_react.useCallback)(async (e2, t) => (S.x = e2, S.y = t, S.z = await y.readDepth(S), S.z = S.z * 2 - 1, 1 - S.z > 1e-7 && S.unproject(v4)), [
    S,
    y,
    v4
  ]), w = (0, import_react.useCallback)(async (t, r = true) => {
    var _a2;
    if (e) x.set(...e);
    else {
      let { x: e2, y: t2 } = n ? g : {
    ...
    r && ((_a2 = u.current) == null ? void 0 : _a2.target) && (s > 0 && t > 0 ? easing.damp3(u.current.target, x, s, t) : u.current.target.copy(x));
  }, [
    e,
    x,
    n,
  ...
  useFrame(async (e2, t) => {
    var _a2;
    o || w(t), f.current && f.current.position.copy(x), p.current && ((_a2 = u.current) == null ? void 0 : _a2.target) && p.current.position.copy(u.current.target);
  });
  let T2 = (0, import_react.useMemo)(() => ({
    dofRef: u,
    hitpoint: x,
    update: w
  }), [x, w]);
  return (0, import_react.useImperativeHandle)(c2, () => T2, [T2]), (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [i ? createPortal((0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsxs)("mesh", {
    ref: f,
  ...
  })] }), m2) : null, (0, import_jsx_runtime.jsx)(Ke, {
    ref: u,
    ...l,
    target: x
  })] });
}
var Ye = $(BloomEffect, { blendFunction: 0 });
var Xe = $(BrightnessContrastEffect);
function Ze({ ref: e, ...t }) {
  let n = Z(t, "offset"), r = (0, import_react.useMemo)(() => new ChromaticAberrationEffect({
    ...t,
    offset: n
  }), [n, t]);
  return X(r), (0, import_jsx_runtime.jsx)("primitive", {
    object: r,
    ref: e
  });
}
function Qe({ blendFunction: e = 23, ref: t }) {
  let n = (0, import_react.useMemo)(() => new ColorAverageEffect(e), [e]);
  return X(n), (0, import_jsx_runtime.jsx)("primitive", {
    object: n,
    ref: t
  });
}
var $e = $(ColorDepthEffect);
var et = $(DepthEffect);
var tt = $(DotScreenEffect);
var nt = $(FXAAEffect);
function rt({ active: e = true, ref: t, ...n }) {
  let r = useThree((e2) => e2.invalidate), i = Z(n, "delay"), o = Z(n, "duration"), s = Z(n, "strength"), c2 = Z(n, "chromaticAberrationOffset"), l = (0, import_react.useMemo)(() => new GlitchEffect({
    ...n,
    delay: i,
    duration: o,
    strength: s,
    chromaticAberrationOffset: c2
  }), [
    i,
    o,
    n,
  ...
  return (0, import_react.useLayoutEffect)(() => {
    l.mode = e ? n.mode || GlitchMode.SPORADIC : GlitchMode.DISABLED, r();
  }, [
    e,
    l,
    r,
    n.mode
  ]), X(l), (0, import_jsx_runtime.jsx)("primitive", {
    ref: t,
    object: l
  });
}
function it({ ref: e, ...t }) {
  let { camera: n } = (0, import_react.useContext)(G), r = (0, import_react.useMemo)(() => new GodRaysEffect(n, J(t.sun), t), [n, t]);
  return (0, import_react.useLayoutEffect)(() => void (r.lightSource = J(t.sun)), [r, t.sun]), X(r), (0, import_jsx_runtime.jsx)("primitive", {
    ref: e,
    object: r
  });
}
function at({ size: e, ref: t, ...n }) {
  let r = useThree((e2) => e2.invalidate), i = (0, import_react.useMemo)(() => new GridEffect(n), [n]);
  return (0, import_react.useLayoutEffect)(() => {
...
var lt = $(ct);
var ut = ({ smoothTime: e = 0.07, blendFunction: t = 23, enabled: n = true, glareSize: i = 0.2, lensPosition: o = new Vector3(-25, 6, -60), screenRes: s = new Vector2(0, 0), starPoints: c2 = 6, flareSize: l = 0.01, flareSpeed: u = 0.01, flareShape: d = 0.01, animated: f = true, anamorphic: p = false, colorGain: m2 = new Color(20, 20, 20), lensDirtTexture: h = null, haloScale: g = 0.5, secondaryGhosts: _ = true, aditionalStreaks: v4 = true, ghostScale: y = 0, opacity: b = 1, starBurst: x = false }) => {
  let S = useThree(({ viewport: e2 }) => e2), C2 = useThree(({ raycaster: e2 }) => e2), { scene: w, camera: T2 } = (0, import_react.useContext)(G), [E] = (0, import_react.useState)(() => new Vector2()), [D] = (0, import_react.useState)(() => new Vector3()), O = (0, import_react.useRef)(null);
  return useFrame((t2, n2) => {
    var _a2, _b2, _c2;
    if (!(O == null ? void 0 : O.current)) return;
    let r = O.current.uniforms.get("lensPosition"), i2 = O.current.uniforms.get("opacity");
    if (!r || !i2) return;
    let a = 1;
    if (D.copy(o).project(T2), D.z > 1) return;
    r.value.x = D.x, r.value.y = D.y, E.x = D.x, E.y = D.y, C2.setFromCamera(E, T2);
    let { object: s2 } = C2.intersectObjects(w.children, true)[0] || {};
    s2 && (((_a2 = s2.userData) == null ? void 0 : _a2.lensflare) === "no-occlusion" ? a = 0 : s2 instanceof Mesh && (((_c2 = (_b2 = s2.material.uniforms) == null ? void 0 : _b2._transmission) == null ? void 0 : _c2.value) > 0.2 || s2.material._transmission && s2.material._transmission > 0.2 ? a = 0.2 : s2.material.transparent && (a = s2.material.opacity))), easing.damp(i2, "value", a, e, n2);
  }), (0, import_react.useEffect)(() => {
    if (!(O == null ? void 0 : O.current)) return;
    let e2 = O.current.uniforms.get("screenRes");
    e2 && (e2.value.x = S.width, e2.value.y = S.height);
  }, [S]), (0, import_jsx_runtime.jsx)(lt, {
    ref: O,
    blendFunction: t,
    enabled: n,
    glareSize: i,
...
function dt({ lut: e, tetrahedralInterpolation: t, ref: n, ...r }) {
  let i = (0, import_react.useMemo)(() => new LUT3DEffect(e, r), [e, r]), o = useThree((e2) => e2.invalidate);
  return (0, import_react.useLayoutEffect)(() => {
...
var ft = $(NoiseEffect, { blendFunction: 5 });
function pt({ selection: e = q, selectionLayer: t = 10, blendFunction: n, patternTexture: r, patternScale: i, edgeStrength: a, pulseSpeed: o, visibleEdgeColor: s, hiddenEdgeColor: c2, multisampling: l, resolutionScale: u, resolutionX: d, resolutionY: f, width: p, height: m2, kernelSize: h, blur: g, xRay: _, ref: v4 }) {
  let { scene: y, camera: b } = (0, import_react.use)(G), x = (0, import_react.useMemo)(() => new OutlineEffect(y, b, {
    blendFunction: n,
    patternTexture: r,
    patternScale: i,
    edgeStrength: a,
  ...
  return Y(x, e, t), X(x), (0, import_jsx_runtime.jsx)("primitive", {
    ref: v4,
    object: x
  });
}
function mt({ granularity: e = 5, ref: t }) {
  let n = (0, import_react.useMemo)(() => new PixelationEffect(e), [e]);
  return X(n), (0, import_jsx_runtime.jsx)("primitive", {
    ref: t,
    object: n
  });
...
var _t = class extends Effect {
  constructor({ rampType: e = 0, rampStart: t = [0.5, 0.5], rampEnd: n = [1, 1], startColor: r = [
    0,
    0,
    0,
    1
    ...
    1,
    1
  ], rampBias: a = 0.5, rampGain: o = 0.5, rampMask: s = false, rampInvert: c2 = false, ...l } = {}) {
    super("RampEffect", ht.fragmentShader, {
      ...l,
      uniforms: /* @__PURE__ */ new Map([
        ["rampType", new Uniform(e)],
        ["rampStart", new Uniform(t)],
        ["rampEnd", new Uniform(n)],
        ["startColor", new Uniform(r)],
        ["endColor", new Uniform(i)],
        ["rampBias", new Uniform(a)],
        ["rampGain", new Uniform(o)],
        ["rampMask", new Uniform(s)],
        ["rampInvert", new Uniform(c2)]
      ])
    });
  }
};
var vt = $(_t);
var yt = $(ScanlineEffect, {
  blendFunction: 24,
  density: 1.25
});
var bt = (e, t) => e.layers.enable(t.selection.layer);
var xt = (e, t) => e.layers.disable(t.selection.layer);
function St({ selection: e = q, selectionLayer: t = 10, lights: n = q, inverted: r = false, ignoreBackground: i = false, luminanceThreshold: o, luminanceSmoothing: s, mipmapBlur: c2, intensity: l, radius: u, levels: d, kernelSize: f, resolutionScale: p, width: m2, height: h, resolutionX: g, resolutionY: _, ref: v4 }) {
  let { scene: y, camera: b } = (0, import_react.use)(G), x = useThree((e2) => e2.invalidate), S = (0, import_react.useMemo)(() => {
    let e2 = new SelectiveBloomEffect(y, b, {
      blendFunction: 0,
    ...
    return e2.inverted = r, e2.ignoreBackground = i, e2;
  }, [
    y,
    b,
    o,
  ...
  return Y(S, e, t), (0, import_react.useEffect)(() => {
    if (n.length === 0) {
      console.warn("SelectiveBloom requires lights to work.");
      return;
    }
    let e2 = n.map((e3) => J(e3)).filter((e3) => e3 != null);
    if (e2.length !== 0) return e2.forEach((e3) => bt(e3, S)), x(), () => {
      e2.forEach((e3) => xt(e3, S)), x();
    };
  }, [
    S,
    x,
    n,
    t
  ]), X(S), (0, import_jsx_runtime.jsx)("primitive", {
    ref: v4,
    object: S
  });
}
var Ct = $(SepiaEffect);
var wt = $(ShockWaveEffect);
var Tt = $(SMAAEffect);
function Et({ ref: e, ...t }) {
  let { camera: n, normalPass: r, downSamplingPass: i, resolutionScale: a } = (0, import_react.useContext)(G), o = (0, import_react.useMemo)(() => r === null && i === null ? (console.error("Please enable the NormalPass in the EffectComposer in order to use SSAO."), {}) : new SSAOEffect(n, r && !i ? r.texture : null, {
    blendFunction: 21,
    samples: 30,
    rings: 4,
    distanceThreshold: 1,
  ...
  return X(o), (0, import_jsx_runtime.jsx)("primitive", {
    ref: e,
    object: o
  });
}
function Dt({ textureSrc: e, texture: t, opacity: n = 1, ref: r, ...a }) {
  let o = useLoader(TextureLoader, e);
  (0, import_react.useLayoutEffect)(() => {
    o.colorSpace = SRGBColorSpace, o.wrapS = o.wrapT = RepeatWrapping;
  }, [o]);
  let s = (0, import_react.useMemo)(() => new TextureEffect({
    ...a,
    texture: o || t
  }), []);
  return X(s), (0, import_jsx_runtime.jsx)("primitive", {
...
var Ot = $(TiltShiftEffect, { blendFunction: 0 });
...
var At = class extends Effect {
  constructor({ blendFunction: e = 23, blur: t = 0.15, taper: n = 0.5, start: r = [0.5, 0], end: i = [0.5, 1], samples: a = 10, direction: o = [1, 1] } = {}) {
    super("TiltShiftEffect", kt.fragmentShader, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["start", new Uniform(r)],
        ["end", new Uniform(i)],
        ["samples", new Uniform(a)],
        ["direction", new Uniform(o)]
      ])
    });
  }
};
var jt = $(At, { blendFunction: 23 });
var Mt = $(ToneMappingEffect);
var Nt = $(VignetteEffect);
var Pt = { fragmentShader: "\n    uniform float factor;\n\n    void mainImage(const in vec4 inputColor, const in vec2 uv, out vec4 outputColor) {\n      vec2 vUv = uv;\n      float frequency = 6.0 * factor;\n      float amplitude = 0.015 * factor;\n      float x = vUv.y * frequency + time * 0.7; \n      float y = vUv.x * frequency + time * 0.3;\n      vUv.x += cos(x + y) * amplitude * cos(y);\n      vUv.y += sin(x - y) * amplitude * cos(y);\n      vec4 rgba = texture(inputBuffer, vUv);\n      outputColor = rgba;\n    }\n  " };
var Ft = class extends Effect {
  constructor({ blendFunction: e = 23, factor: t = 0 } = {}) {
    super("WaterEffect", Pt.fragmentShader, {
      blendFunction: e,
      attributes: 2,
      uniforms: /* @__PURE__ */ new Map([["factor", new Uniform(t)]])
    });
  }
};
var It = $(Ft, { blendFunction: 23 });
function Lt({ halfRes: t, screenSpaceRadius: n, quality: r, depthAwareUpsampling: i = true, aoRadius: o = 5, aoSamples: s = 16, denoiseSamples: c2 = 4, denoiseRadius: l = 12, distanceFalloff: u = 1, intensity: d = 1, color: f, renderMode: p = 0, ref: m2 }) {
  let { camera: h, scene: g } = useThree(), _ = (0, import_react.useMemo)(() => new $87431ee93b037844$export$2489f9981ab0fa82(g, h), [h, g]);
  return X(_), (0, import_react.useLayoutEffect)(() => {
    applyProps(_.configuration, {
      color: f,
      aoRadius: o,
      distanceFalloff: u,
      intensity: d,
  ...
  }, [_, r]), (0, import_jsx_runtime.jsx)("primitive", {
    ref: m2,
    object: _
  });
}
export {
  ...
  Je as Autofocus,
  Ye as Bloom,
  Xe as BrightnessContrast,
  Ze as ChromaticAberration,
  Qe as ColorAverage,
  $e as ColorDepth,
  et as Depth,
  Ke as DepthOfField,
  tt as DotScreen,
  q as EMPTY_ARRAY,
  Ne as EffectComposer,
  G as EffectComposerContext,
  nt as FXAA,
  rt as Glitch,
  it as GodRays,
  at as Grid,
  ...
  Ie as Select,
  Pe as Selection,
  St as SelectiveBloom,
  Ct as Sepia,
  wt as ShockWave,
  Dt as Texture,
  Ot as TiltShift,
  jt as TiltShift2,
  At as TiltShiftEffect,
  Mt as ToneMapping,
  Nt as Vignette,
  It as WaterEffect,
  Ft as WaterEffectImpl,
  J as resolveRef,
  K as selectionContext,
  X as useDispose,
  Y as useSelectionSync,
  Z as useVector2,
  $ as wrapEffect
};
